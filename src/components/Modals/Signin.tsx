...
const Signin: React.FC = () => {
    ...
    return (
        <Portal >
            <div className='w-full h-full absolute bg-black/20 flex items-center justify-center' onClick={() => setSigninModal(false)}>
                {!phoneModal ? <div onClick={(e) => e.stopPropagation()} className='w-100 transition-all duration-700 rounded-2xl bg-secondary border border-gray-400/30 text-black p-6 shadow-2xl'>
                    <button
                        // onClick={onClose}
                    ...
                    <div className="mt-6 space-y-3">
                        ...
                        <button onClick={() => setPhoneModal(true)} className="w-full bg-white border border-gray-200 py-3 rounded-full font-semibold flex items-center justify-center gap-2 cursor-pointer">
